...
% function [n_conexiones_cada_nodos, Suma_pesos_cada_nodo, Correlacion_entre_grados_nodos, Densidad_conexiones, Coef_cluster, T, estructura_optima,modularidad_maximizada, Matriz_distancias_mas_cortas_de_todos_nodos,lambda,efficiency,ecc,radius,diameter, BC]=Prueba_brain(grafo,grafo_binario)
...
Correlacion_entre_grados_nodos=assortativity(grafo_binario,0); % valor positivo indica que los nodos tienden a unirse con nodos con el mismo grado
Densidad_conexiones=density_und(grafo_binario);
...
[lambda,efficiency,ecc,radius,diameter]=charpath(Matriz_distancias_mas_cortas_de_todos_nodos) ;

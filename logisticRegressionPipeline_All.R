...
initialInfo <-
  read_excel(
    "E:/Pablo/Neuroblastoma/Results/capturingFeatures/Human/NuevosCasos/Analysis/NewClinicClassification_NewControls_11_01_2018.xlsx"
  )

dependentCategory <- "Instability" #"Instability" or "RiskCalculated"

missingValuesVTN <- initialInfo$`VTN++ - Sorting` == 0 & initialInfo$`VTN++ - Iteration` == 0;
missingValuesCD31 <- initialInfo$`CD31+ - Sorting` == 0 & initialInfo$`CD31+ - Iteration` == 0;
missingValuesCOL <- initialInfo$`COL+ - Sorting` == 0 & initialInfo$`COL+ - Iteration` == 0;
missingValuesGAGs <- initialInfo$`GAGs+ - Sorting` == 0 & initialInfo$`GAGs+ - Iteration` == 0;
missingValuesCD240 <- initialInfo$`CD240 - Sorting` == 0 & initialInfo$`CD240 - Iteration` == 0;
...
# Missing VTN++ values
initialInfoDicotomized$`VTN++ - Sorting`[missingValuesVTN] <- 999;
initialInfoDicotomized$`VTN++ - Iteration`[missingValuesVTN] <- 999;
initialInfoDicotomized$`VTN++ - MST`[missingValuesVTN] <- 999;
initialInfo$`VTN++ - Sorting`[missingValuesVTN] <- 0;
initialInfo$`VTN++ - Iteration`[missingValuesVTN] <- 0;
initialInfo$`VTN++ - MST`[missingValuesVTN] <- 0;

# Missing CD31+ values
initialInfoDicotomized$`CD31+ - Sorting`[missingValuesCD31] <- 999;
initialInfoDicotomized$`CD31+ - Iteration`[missingValuesCD31] <- 999;
initialInfoDicotomized$`CD31+ - MST`[missingValuesCD31] <- 999;
initialInfo$`CD31+ - Sorting`[missingValuesCD31] <- 0;
initialInfo$`CD31+ - Iteration`[missingValuesCD31] <- 0;
initialInfo$`CD31+ - MST`[missingValuesCD31] <- 0;

# Missing COL values
initialInfoDicotomized$`COL+ - Sorting`[missingValuesCOL] <- 999;
initialInfoDicotomized$`COL+ - Iteration`[missingValuesCOL] <- 999;
initialInfoDicotomized$`COL+ - MST`[missingValuesCOL] <- 999;
initialInfo$`COL+ - Sorting`[missingValuesCOL] <- 0;
initialInfo$`COL+ - Iteration`[missingValuesCOL] <- 0;
initialInfo$`COL+ - MST`[missingValuesCOL] <- 0;

# Missing GAGs values
initialInfoDicotomized$`GAGs+ - Sorting`[missingValuesGAGs] <- 999;
initialInfoDicotomized$`GAGs+ - Iteration`[missingValuesGAGs] <- 999;
initialInfoDicotomized$`GAGs+ - MST`[missingValuesGAGs] <- 999;
initialInfo$`GAGs+ - Sorting`[missingValuesGAGs] <- 0;
initialInfo$`GAGs+ - Iteration`[missingValuesGAGs] <- 0;
initialInfo$`GAGs+ - MST`[missingValuesGAGs] <- 0;

# Missing CD240 values
initialInfoDicotomized$`CD240 - Sorting`[missingValuesCD240] <- 999;
initialInfoDicotomized$`CD240 - Iteration`[missingValuesCD240] <- 999;
initialInfoDicotomized$`CD240 - MST`[missingValuesCD240] <- 999;
initialInfo$`CD240 - Sorting`[missingValuesCD240] <- 0;
initialInfo$`CD240 - Iteration`[missingValuesCD240] <- 0;
initialInfo$`CD240 - MST`[missingValuesCD240] <- 0;
